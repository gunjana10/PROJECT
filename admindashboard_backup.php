...
if (isset($_POST['action'])) {
    ...
    if (isset($actions[$_POST['action']])) {
        ...
        $messages = ["Booking confirmed!","Booking cancelled!","Booking deleted!","User status updated!","User deleted!","Destination deleted!"];
        ...
        <?php if ($page == 'dashboard'): ?>
            <div class="stats-grid">
                ...
                $statCards = [
                    ...
                    ['Total Revenue', 'Rs ' . number_format($stats['revenue']), 'fas fa-rupee-sign', '#9d4edd'],
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row['hotel_category'] ?? 'Basic'); ?></td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <!-- CONFIRM button - shows for pending and cancelled bookings -->
                                    <?php if ($row_status == 'pending' || $row_status == 'cancelled'): ?>
                                    ...
                                    <!-- CANCEL button - shows for pending and confirmed bookings -->
                                    <?php if ($row_status == 'pending' || $row_status == 'confirmed'): ?>
                                    <form method="POST" style="display: inline;">
                                        <input type="hidden" name="booking_id" value="<?php echo $row['id']; ?>">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['destination']); ?></td>
                                <td><?php echo htmlspecialchars($row['package'] ?? 'Basic Pilgrimage'); ?></td>
                                <td><?php echo htmlspecialchars($row['hotel_category'] ?? 'Basic Hotel'); ?></td>
                                <td><?php echo htmlspecialchars($row['transport_type'] ?? 'Bus'); ?></td>
                                <td><?php echo htmlspecialchars($row['travelers'] ?? 1); ?> persons</td>
                                <td>
                                    <div style="font-size: 0.85rem;">
                                        <div><?php echo date('d M', strtotime($row['start_date'])); ?></div>
                                        <div><?php echo date('d M', strtotime($row['end_date'])); ?></div>
                                    </div>
                                </td>
                                <td><strong style="color: var(--primary);">Rs <?php echo number_format($row['price']); ?></strong></td>
                                <td>
                                    <span class="status-badge status-<?php echo $row_status; ?>">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-help">Price format: Rs 21,480 or Rs 45,000</div>
                        </div>
                    </div>
            ...
            content.innerHTML = `
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                    ...
                    <div>
                        ...
                        <div style="font-weight: 700; color: var(--primary);">Rs ${parseFloat(booking.price).toLocaleString('en-IN')}</div>
                    </div>
                    <div>
